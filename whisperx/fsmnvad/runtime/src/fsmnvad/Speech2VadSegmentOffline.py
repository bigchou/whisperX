...
from whisperx.fsmnvad.runtime.src.fsmnvad.VadOrtInferSession import VadOrtInferSession
...
class E2EVadModel:
    ...
    def compute_decibel(self) -> None:
        ...
        #import pdb; pdb.set_trace()
        # self.waveform.shape[1] = 7697897
        # self.waveform.shape[1] - frame_sample_length + 1 = 7697498
    ...
    def get_frame_state(self, t: int) -> FrameState:
        ...
        # if sum_score > 0.5:
        #     print(0, t,0 )
        assert 1.0 >= sum_score >= 0.0, "something wrong"
