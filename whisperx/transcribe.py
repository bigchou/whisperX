...
def cli():
    ...
    # vad params
    parser.add_argument('--vad_model', type=str, default=None, choices=["pyannet", "silerov4", "silerov5.1", "fsmnvad"], help='select the VAD whatever you want')
    ...
    for audio_path in args.pop("audio"):
        ...
        # {'segments': [{'text': ' Do-ee-wo-er', 'start': 30.323, 'end': 31.602}], 'language': 'en'} <--- fsmnvad
    ...
    # Part 2: Align Loop
    if vad_model in ['silerov4', 'silerov5.1', 'fsmnvad']:
